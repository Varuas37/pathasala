...
import StatsCard from "../../assets/images/statsCard.svg"
import svgGroup from "../../assets/images/Group.svg"
...
[
    {
        ...
        svg:svgGroup,
        description:"Pathsala reccomends questions after an intial assesment of your knowledge on the topic. We provide questions that are tailored to you to help you succed in your upcomming exams"
    },
    {
        id:1,
        title:"Personalized Stats",
        svg:StatsCard,
        description:"Keep track of all your assignments and quzzies with our powerful suite of tools and analytics."
    },
    {
        id:2,
        title:"Hundreds of Question Sets",
        svg:svgSearchCard,
        description:"Pathsala has over 1000 questions on different topics. You can also search for flash cards or question sets generated by our users"
    }
]

// *Banner Data
export const bannerText = "Sign up for free!"
export const btnBanner = "Get Started!"
export const bannerSubHeading = "START LEARNING"